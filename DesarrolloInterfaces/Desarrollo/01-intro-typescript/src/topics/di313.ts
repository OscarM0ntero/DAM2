// Función para mostrar elementos de un array
function mostrarElementosArray<T>(array: T[]): void 
{
    array.forEach((e, i) => 
    {
        console.log(`Posición ${i}:`, e);
    });
}
...
class Partido 
{
    ...
    obtenerResultado(): string 
    {
        ...
        const resultado = `${equipoGanador.getNombreEquipo()} ha ganado por ${setsGanadosEquipo1} sets a ${setsGanadosEquipo2}.`;
        return resultado;
    }
}
...
const jugador1 = new JugadorImpl("Juan", "López", "M", "111-111-111", direccion1, 3);
const jugador2 = new JugadorImpl("Pedro", "Martín", "M", "222-222-222", direccion2, 4);
const jugador3 = new JugadorImpl("Luis", "Carrasco", "M", "333-333-333", direccion1, 5);
const jugador4 = new JugadorImpl("Carlos", "Beltrán", "M", "444-444-444", direccion2, 2);
const jugador5 = new JugadorImpl("Pepe", "García", "M", "555-555-555", direccion1, 1);
const jugador6 = new JugadorImpl("Teresa", "Murillo", "F", "666-666-666", direccion2, 6);
...
const arbitro1 = new ArbitroImpl("Ana", "Gómez", "F", "777-777-777", direccion1, "ARB001");
const arbitro2 = new ArbitroImpl("María", "Pérez", "F", "888-888-888", direccion2, "ARB002");

const calendario = new Calendario();

const partido1 = new Partido(equipo1, equipo2, new Date("2023-10-01T10:00:00"), "Polideportivo A", "Pista 1", arbitro1);
partido1.agregarSet(6, 4);
partido1.agregarSet(3, 6);
partido1.agregarSet(5, 7);

const partido2 = new Partido(equipo2, equipo3, new Date("2023-10-05T10:00:00"), "Polideportivo B", "Pista 2", arbitro2);
partido2.agregarSet(3, 6);
partido2.agregarSet(4, 6);

const partido3 = new Partido(equipo1, equipo3, new Date("2023-10-08T10:00:00"), "Polideportivo A", "Pista 1", arbitro1);
...
const jugadoresCampeonato = [jugador1, jugador2, jugador3, jugador4, jugador5, jugador6];

// Mostramos la lista del calendario
console.log("Calendario de Partidos:");
mostrarElementosArray(calendario.obtenerPartidos());

// Mostramos la lista de jugadores
console.log("Jugadores del Campeonato:");
mostrarElementosArray(jugadoresCampeonato);