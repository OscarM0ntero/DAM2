...
class Partido 
{
    ...
    obtenerResultado(): string 
    {
        ...
        const resultado = `${equipoGanador.getNombreEquipo()} ha ganado por ${setsGanadosEquipo1 > setsGanadosEquipo2 ? setsGanadosEquipo1 : setsGanadosEquipo2} sets a ${setsGanadosEquipo1 > setsGanadosEquipo2 ? setsGanadosEquipo2 : setsGanadosEquipo1}.`;
        return resultado;
    }
}
...
class Calendario 
{
    ...
    mostrarCalendario(): void 
    {
        ...
        {
            console.log(`Partido entre ${partido.equipo1.getNombreEquipo()} y ${partido.equipo2.getNombreEquipo()}`);
