...
INSERT INTO `articulos` VALUES (1,'Camiseta Verde',50,14.99),(2,'Camiseta Azul',30,14.99),(3,'Shorts Negros',40,19.99),(4,'Zapatillas Blancas',20,31.99);
...
CREATE TABLE `envios` (
  ...
  CONSTRAINT `codrider_fk` FOREIGN KEY (`codrider`) REFERENCES `riders` (`codrider`) ON UPDATE CASCADE
...
CREATE TABLE `pedidos` (
  ...
  PRIMARY KEY (`codped`),
  KEY `codart_fk_idx` (`codart`),
  CONSTRAINT `codart_fk` FOREIGN KEY (`codart`) REFERENCES `articulos` (`codart`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `riders` (
  `codrider` int NOT NULL AUTO_INCREMENT,
